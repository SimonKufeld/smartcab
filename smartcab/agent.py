...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            #self.epsilon = 1/(math.sqrt(self.t)) if self.t < 30.0 else 0.05
            
            #self.epsilon = self.epsilon / (self.t)
            self.epsilon = 1 / (self.t)
            #self.epsilon = 1 / (math.sqrt(self.t))
            # self.epsilon = self.epsilon - 0.05
            #self.epsilon = max(1.0/(self.t**2),0.1) if self.t < 20 else 0
            #self.epsilon = 0.8 if self.t < 11.0 else 1/self.t - 0.01
